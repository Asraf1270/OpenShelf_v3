                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="container" style="width: 100%; max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
                    <tr>
                        <td class="header" style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); padding: 40px 20px; text-align: center;">
                            <div class="logo">📢</div>
                            <h1 style="color: #ffffff; margin: 0; font-size: 28px; font-family: sans-serif;">Request Update</h1>
                        </td>
                    </tr>
                    <tr>
                        <td class="content" style="padding: 40px 30px; font-family: sans-serif; font-size: 16px; line-height: 1.6; color: #334155;">
                            ...
                            <p style="margin: 0 0 20px;">We wanted to let you know that your request for <strong>"<?php echo htmlspecialchars($book_title); ?>"</strong> has been declined by the owner.</p>
                            ...
                            <div class="reason-box" style="background: #fef2f2; border-left: 4px solid #ef4444; padding: 20px; border-radius: 12px; margin: 20px 0;">
                                <p style="margin: 0; font-weight: 600; color: #b91c1c;">Reason provided:</p>
                                <p style="margin: 10px 0 0 0; color: #991b1b;"><?php echo nl2br(htmlspecialchars($rejection_reason)); ?></p>
                            </div>
                            <?php endif; ?>
                            
                            <div class="suggestions" style="background: #f8fafc; border-radius: 12px; padding: 20px; margin: 20px 0; border: 1px solid #e2e8f0;">
                                <p style="margin: 0 0 10px;"><strong>💡 What you can do next:</strong></p>
                                <ul style="margin: 0; padding-left: 20px;">
                                    <li style="margin-bottom: 8px;">Browse other available books in the library</li>
                                    <li style="margin-bottom: 8px;">Try requesting a different book</li>
                                    <li style="margin-bottom: 8px;">Contact the owner directly if you have questions</li>
                                </ul>
                            </div>
                            
                            <div style="text-align: center; margin-top: 25px;">
                                <a href="<?php echo $base_url; ?>/books/" class="button" style="display: inline-block; padding: 14px 32px; background-color: #6366f1; color: #ffffff; text-decoration: none; border-radius: 40px; font-weight: 600; font-size: 16px;">Browse More Books</a>
                            </div>
                            
                            <p style="margin-top: 30px; font-size: 14px; color: #64748b; border-top: 1px solid #e2e8f0; padding-top: 20px; text-align: center;">Don't let this discourage you! There are many other books waiting to be discovered.</p>
                        </td>
                    </tr>
                    <tr>
